...
export const I18N = {
  de: {
    ...
    start: 'Start', pressEnter: 'Enter ↵ drücken', takes: 'Dauert etwa 1 Minute', back: 'Zurück', ok: 'Weiter', send: 'Senden',
  ...
  en: {
    ...
    start: 'Start', pressEnter: 'press Enter ↵', takes: 'Takes about 1 minute', back: 'Back', ok: 'Next', send: 'Send',
    sending: 'Sending …',
...
/**
 * Greetings for the rotating headline in the contact overlay — same list and
 * order as lue.studio/contact, which this animation is modelled on.
 */
export const GREETINGS = [
  "Hello", "Merhaba", "Hola", "Bonjour", "Ciao", "Hallo", "Ol\u00e1",
  "\u041f\u0440\u0438\u0432\u0435\u0442", "\u4f60\u597d",
  "\u3053\u3093\u306b\u3061\u306f", "\uc548\ub155\ud558\uc138\uc694",
  "\u0928\u092e\u0938\u094d\u0924\u0947", "Hej", "Hoi",
  "\u0393\u03b5\u03b9\u03b1 \u03c3\u03b1\u03c2", "Hei", "Ahoj", "Szia",
  "\u0e2a\u0e27\u0e31\u0e2a\u0e14\u0e35",
];

/** Milliseconds between two greetings (lue.studio uses 2000). */
export const GREETING_INTERVAL = 2000;

/** Start on the visitor's own language, then cycle through the rest. */
export const GREETING_START = {
  de: GREETINGS.indexOf("Hallo"),
  en: GREETINGS.indexOf("Hello"),
};
...
const LIVE = { kind: "● live", kindColor: "#a6c8ff" };
const SOURCE = { kind: "↗ source", kindColor: "#707f96" };
